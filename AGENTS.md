...
- 기본 설치는 master 최신 기준이며, 안정 버전은 `v0.1`부터 `install.sh --v v0.1`로 tag 기준 설치할 수 있게 준비했습니다. v0.6을 v6.0, v0.6.1을 v6.1 기준으로 보존하고, 현재 작업 기준은 v0.6.2(v6.2)입니다. 절대 성능 목표 미달 항목은 후속 과제로 추적합니다.
